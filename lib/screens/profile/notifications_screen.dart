...
class _NotificationsScreenState extends State<NotificationsScreen> {
  bool _showAll = false; // State to toggle between 3 and all announcements
  ...
  Stream<List<Map<String, dynamic>>> _fetchAnnouncements() {
    ...
    return FirebaseFirestore.instance
      ...
      // Show if type is ALL or userId is in to array
            ...
            children: [
              StreamBuilder<List<Map<String, dynamic>>>(
                ...
                builder: (context, snapshot) {
                  ...
                  // Sort announcements by timestamp in descending order (latest first)
                      ...
                      return Column(
                        children: [
                          ...displayedAnnouncements.map((data) {
                            ...
                            final isLong = announcement.length > 100; // Truncate if > 100 chars
...
class NotificationDetailScreen extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    final double baseFontSize = screenWidth * 0.04; // Responsive font size
    final double basePadding = screenWidth * 0.05; // Responsive padding
